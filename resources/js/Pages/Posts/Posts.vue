                ...
                >
                    <div class="p-6 text-gray-900">
                        ...
                        <h1>Posts</h1>
                                ...
                                <div>
                                    <input v-model="filters.title" @input="fetchPosts" placeholder="Filter by title" />
                                    <input v-model="filters.content" @input="fetchPosts" placeholder="Filter by content" />
                                </div>
                                ...
                                <div>
                                    <button :disabled="posts.prev_page_url === null" @click="fetchPosts(posts.prev_page_url)">Previous</button>
                                    <button :disabled="posts.next_page_url === null" @click="fetchPosts(posts.next_page_url)">Next</button>
                                </div>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="flex-1 flex items-center space-x-2">
                    <h5>
                        ...
                        <span class="dark:text-white">{{ posts.total }}</span>
                    </h5>
            ...
            <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t dark:border-gray-700">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <button type="button" id="createProductButton" data-modal-toggle="createProductModal" class="flex items-center justify-center text-black bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center space-x-4">
                                    <button type="button" data-drawer-target="drawer-update-product" data-drawer-show="drawer-update-product" aria-controls="drawer-update-product" class="py-2 px-3 flex items-center text-sm font-medium text-center text-black bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
  ...
  export default {
    ...
    methods: {
      fetchPosts(url = '/api/posts') {
        let apiUrl = url; //'/api/posts';
  //dd(this.filters);
        // Add filter query params if present
        if (this.filters.title) {
          apiUrl = `${apiUrl}?title=${this.filters.title}`;
          dd(apiUrl);
        }
